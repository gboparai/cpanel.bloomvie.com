...
@Component({
  selector: 'app-parent-media-request',
  standalone: true,
  imports: [    
    RouterModule,
  ...
  providers:[DatePipe],
  templateUrl: './parent-media-request.component.html',
  styleUrl: './parent-media-request.component.css'
})
export class ParentMediaRequestComponent {
